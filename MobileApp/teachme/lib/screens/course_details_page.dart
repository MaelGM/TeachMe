    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          ...
          PageRouteBuilder(
            pageBuilder:
                (_, __, ___) =>
                    ProfilePage(user: TeacherService.teacherUserAcount),
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          title: Text(
            TeacherService.teacherUserAcount.username,
            maxLines: 1,
      ...
      children: [
        CircleAvatar(
          backgroundImage: NetworkImage(
            TeacherService.teacherUserAcount.profilePicture,
          ),
        ...
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color:
                  TeacherService.teacherUserAcount.connected == 'yes'
                      ? Colors.green
                      : Colors.grey,
  ...
  Row _showUserScore() {
    return Row(
      ...
      children: [
        ...
        const SizedBox(width: 4),
        Text(
          "(${TeacherService.teacher.ratingCount.toInt()})",
