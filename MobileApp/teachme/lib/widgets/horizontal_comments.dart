  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(
          height: 180, // Ajusta según necesites
    ...
    return Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                print('see all');
                //TODO: Un push a una pantalla simple con todos los comentarios
              }, 
              style: ButtonStyle(
              ...
              child: Text('See all', style: TextStyle(color: Color(0xFF3B82F6), fontSize: 16),)
            )
          ],
        );
  }
