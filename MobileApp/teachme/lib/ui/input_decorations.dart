    ...
    return InputDecoration(
      ...
      focusedBorder: const UnderlineInputBorder(
        borderSide: BorderSide(
          color: Color.fromRGBO(66, 191, 100, 1),
          width: 2,
        ),
      ),
      hintText: hintText,
      ...
      prefixIcon:
          prefixIcon != null
              ? Icon(prefixIcon, color: Color.fromRGBO(66, 191, 100, 1))
              : null,
    );
  }
  ...
  static InputDecoration authInputDecorationBorderFull({
    ...
    return InputDecoration(
      ...
      focusedErrorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(4),
        borderSide: BorderSide(
          color: Color.fromARGB(255, 214, 82, 75),
          width: 2,
        ),
      ),
      ...
      prefixIcon:
          prefixIcon != null
              ? Icon(prefixIcon, color: Color(0xFF3B82F6))
              : null,
      suffixIcon: suffixIcon ?? (Icon(simplySuffixIcon, color: Colors.white)),
    );
  }
